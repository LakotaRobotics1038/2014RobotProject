...
<Project Type="Project" LVVersion="13008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Vision Stuff" Type="Folder">
			<Item Name="2014 Ball Detection.vi" Type="VI" URL="../Vision Stuff/2014 Ball Detection.vi"/>
			<Item Name="2014 Target Detection.vi" Type="VI" URL="../Vision Stuff/2014 Target Detection.vi"/>
			<Item Name="Aspect Ratio Score.vi" Type="VI" URL="../Vision Stuff/Aspect Ratio Score.vi"/>
			<Item Name="Calibration Helper.vi" Type="VI" URL="../Vision Stuff/Calibration Helper.vi"/>
			<Item Name="Compute DistanceToTarget.vi" Type="VI" URL="../Vision Stuff/Compute DistanceToTarget.vi"/>
			<Item Name="Compute Target Distances.vi" Type="VI" URL="../Vision Stuff/Compute Target Distances.vi"/>
			<Item Name="Create Annulus from Rectangle.vi" Type="VI" URL="../Vision Stuff/Create Annulus from Rectangle.vi"/>
			<Item Name="Fit Circle to Find Ball.vi" Type="VI" URL="../Vision Stuff/Fit Circle to Find Ball.vi"/>
			<Item Name="Label Particles.vi" Type="VI" URL="../Vision Stuff/Label Particles.vi"/>
			<Item Name="Label Targets.vi" Type="VI" URL="../Vision Stuff/Label Targets.vi"/>
			<Item Name="Normalize Path.vi" Type="VI" URL="../Vision Stuff/Normalize Path.vi"/>
			<Item Name="Normalized to Scored.vi" Type="VI" URL="../Vision Stuff/Normalized to Scored.vi"/>
			<Item Name="Predict Search Rectangle from Particle.vi" Type="VI" URL="../Vision Stuff/Predict Search Rectangle from Particle.vi"/>
			<Item Name="Process Image for Balls.vi" Type="VI" URL="../Vision Stuff/Process Image for Balls.vi"/>
			<Item Name="Process Image for Target.vi" Type="VI" URL="../Vision Stuff/Process Image for Target.vi"/>
			<Item Name="Rank HV combos.vi" Type="VI" URL="../Vision Stuff/Rank HV combos.vi"/>
			<Item Name="Rectangularity Score.vi" Type="VI" URL="../Vision Stuff/Rectangularity Score.vi"/>
			<Item Name="Score and Rank Objects.vi" Type="VI" URL="../Vision Stuff/Score and Rank Objects.vi"/>
			<Item Name="Score and Rank Target Objects.vi" Type="VI" URL="../Vision Stuff/Score and Rank Target Objects.vi"/>
			<Item Name="Score and Sort Objects.vi" Type="VI" URL="../Vision Stuff/Score and Sort Objects.vi"/>
			<Item Name="Separate Particles.vi" Type="VI" URL="../Vision Stuff/Separate Particles.vi"/>
			<Item Name="Sorted Particle Report.vi" Type="VI" URL="../Vision Stuff/Sorted Particle Report.vi"/>
			<Item Name="TargetType.ctl" Type="VI" URL="../Vision Stuff/TargetType.ctl"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Circle Coverage Score.vi" Type="VI" URL="../Vision Stuff/Circle Coverage Score.vi"/>
			<Item Name="Compare Rects.vi" Type="VI" URL="../Vision Stuff/Compare Rects.vi"/>
		</Item>
